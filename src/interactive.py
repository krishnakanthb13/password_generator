...
class InteractiveMenu:
    ...
    def print_menu(self):
        ...
        print(f"{Fore.YELLOW}  Choose a generator:{Style.RESET_ALL}")
        print(f"{Fore.CYAN}{'═' * 50}{Style.RESET_ALL}")
        
        for key, name, _ in self.MENU_OPTIONS:
            if key == "0":
                print(f"{Fore.CYAN}{'─' * 50}{Style.RESET_ALL}")
            print(f"  {Fore.GREEN}[{key:>2}]{Style.RESET_ALL} {name}")
    ...
    def print_result(self, result, show_entropy: bool = True):
        ...
        print(f"{Fore.WHITE}Generated:{Style.RESET_ALL}")
        ...
        if show_entropy:
            ...
            print(f"  {Fore.YELLOW}Entropy:{Style.RESET_ALL} {result.entropy_bits:.2f} bits")
            print(f"  {Fore.YELLOW}Strength:{Style.RESET_ALL} {strength}")
            print(f"  {Fore.YELLOW}Crack Time:{Style.RESET_ALL} {crack_time}")
    ...
    def handle_phrase(self):
        ...
        print(f"\n{Fore.CYAN}=== Passphrase ==={Style.RESET_ALL}")
    ...
    def handle_leet(self):
        ...
        print(f"\n{Fore.CYAN}=== Leetspeak Passphrase ==={Style.RESET_ALL}")
    ...
    def handle_uuid(self):
        ...
        print(f"\n{Fore.CYAN}=== UUID Token ==={Style.RESET_ALL}")
    ...
    def handle_base64(self):
        ...
        print(f"\n{Fore.CYAN}=== Base64 Secret ==={Style.RESET_ALL}")
    ...
    def handle_jwt(self):
        ...
        print(f"\n{Fore.CYAN}=== JWT Secret ==={Style.RESET_ALL}")
    ...
    def handle_wifi(self):
        ...
        print(f"\n{Fore.CYAN}=== WiFi/WPA Key ==={Style.RESET_ALL}")
    ...
    def handle_license(self):
        ...
        print(f"\n{Fore.CYAN}=== License Key ==={Style.RESET_ALL}")
    ...
    def handle_recovery(self):
        ...
        print(f"\n{Fore.CYAN}=== Recovery Codes ==={Style.RESET_ALL}")
    ...
    def handle_otp(self):
        ...
        print(f"\n{Fore.CYAN}=== OTP Secret ==={Style.RESET_ALL}")
    ...
    def handle_history(self):
        ...
        print(f"\n{Fore.CYAN}=== Password History ==={Style.RESET_ALL}")
